...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<OdomInfo>)))
  ...
  "bb11dda76811d80a5965a15c6b7baf24")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'OdomInfo)))
  "Returns md5sum for a message object of type 'OdomInfo"
  "bb11dda76811d80a5965a15c6b7baf24")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<OdomInfo>)))
  ...
  (cl:format cl:nil "~%Header header~%~%#class rtabmap::OdometryInfo~%#{~%#    bool lost;~%#    int matches;~%#    int inliers;~%#    float variance;~%#    int features;~%#    int localMapSize;~%#    float time;~%#~%#    int type; // 0=BOW, 1=Optical Flow, 2=ICP~%#~%#    // BOW odometry~%#    std::multimap<int, cv::KeyPoint> words;~%#    std::vector<int> wordMatches;~%#    std::vector<int> wordInliers;~%#~%#    // Optical Flow odometry~%#    std::vector<cv::Point2f> refCorners;~%#    std::vector<cv::Point2f> newCorners;~%#    std::vector<int> cornerInliers;~%#}~%~%bool lost~%int32 matches~%int32 inliers~%float32 variance~%int32 features~%int32 localMapSize~%float32 timeEstimation~%float32 timeParticleFiltering~%float32 stamp~%float32 interval~%float32 distanceTravelled~%~%int32 type~%~%int32[] wordsKeys~%KeyPoint[] wordsValues~%int32[] wordMatches~%int32[] wordInliers~%~%Point2f[] refCorners~%Point2f[] newCorners~%int32[] cornerInliers~%~%geometry_msgs/Transform transform~%geometry_msgs/Transform transformFiltered~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: rtabmap_ros/KeyPoint~%#class cv::KeyPoint~%#{~%#    Point2f pt;~%#    float size;~%#    float angle;~%#    float response;~%#    int octave;~%#    int class_id;~%#}~%~%Point2f pt~%float32 size~%float32 angle~%float32 response~%int32 octave~%int32 class_id~%================================================================================~%MSG: rtabmap_ros/Point2f~%#class cv::Point2f~%#{~%#    float x;~%#    float y;~%#}~%~%float32 x~%float32 y~%================================================================================~%MSG: geometry_msgs/Transform~%# This represents the transform between two coordinate frames in free space.~%~%Vector3 translation~%Quaternion rotation~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%~%float64 x~%float64 y~%float64 z~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'OdomInfo)))
  "Returns full string definition for message of type 'OdomInfo"
  (cl:format cl:nil "~%Header header~%~%#class rtabmap::OdometryInfo~%#{~%#    bool lost;~%#    int matches;~%#    int inliers;~%#    float variance;~%#    int features;~%#    int localMapSize;~%#    float time;~%#~%#    int type; // 0=BOW, 1=Optical Flow, 2=ICP~%#~%#    // BOW odometry~%#    std::multimap<int, cv::KeyPoint> words;~%#    std::vector<int> wordMatches;~%#    std::vector<int> wordInliers;~%#~%#    // Optical Flow odometry~%#    std::vector<cv::Point2f> refCorners;~%#    std::vector<cv::Point2f> newCorners;~%#    std::vector<int> cornerInliers;~%#}~%~%bool lost~%int32 matches~%int32 inliers~%float32 variance~%int32 features~%int32 localMapSize~%float32 timeEstimation~%float32 timeParticleFiltering~%float32 stamp~%float32 interval~%float32 distanceTravelled~%~%int32 type~%~%int32[] wordsKeys~%KeyPoint[] wordsValues~%int32[] wordMatches~%int32[] wordInliers~%~%Point2f[] refCorners~%Point2f[] newCorners~%int32[] cornerInliers~%~%geometry_msgs/Transform transform~%geometry_msgs/Transform transformFiltered~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: rtabmap_ros/KeyPoint~%#class cv::KeyPoint~%#{~%#    Point2f pt;~%#    float size;~%#    float angle;~%#    float response;~%#    int octave;~%#    int class_id;~%#}~%~%Point2f pt~%float32 size~%float32 angle~%float32 response~%int32 octave~%int32 class_id~%================================================================================~%MSG: rtabmap_ros/Point2f~%#class cv::Point2f~%#{~%#    float x;~%#    float y;~%#}~%~%float32 x~%float32 y~%================================================================================~%MSG: geometry_msgs/Transform~%# This represents the transform between two coordinate frames in free space.~%~%Vector3 translation~%Quaternion rotation~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%~%float64 x~%float64 y~%float64 z~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
