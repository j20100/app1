...
struct Info_
{
  ...
  _loopClosureId_type loopClosureId;
   ...
   typedef int32_t _localLoopClosureId_type;
  _localLoopClosureId_type localLoopClosureId;
...
// {'sensor_msgs': ['/opt/ros/indigo/share/sensor_msgs/cmake/../msg'], 'geometry_msgs': ['/opt/ros/indigo/share/geometry_msgs/cmake/../msg'], 'std_msgs': ['/opt/ros/indigo/share/std_msgs/cmake/../msg'], 'rtabmap_ros': ['/home/jonathan/catkin_ws/src/rtabmap_ros/msg']}
...
struct MD5Sum< ::rtabmap_ros::Info_<ContainerAllocator> >
{
  ...
  {
    return "8bcbc6ef1887f1743539b800d7fbba0d";
  }

  static const char* value(const ::rtabmap_ros::Info_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x8bcbc6ef1887f174ULL;
  static const uint64_t static_value2 = 0x3539b800d7fbba0dULL;
};
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::rtabmap_ros::Info_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      ...
      stream.next(m.localLoopClosureId);
...
struct Printer< ::rtabmap_ros::Info_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::rtabmap_ros::Info_<ContainerAllocator>& v)
  {
    ...
    s << indent << "localLoopClosureId: ";
    Printer<int32_t>::stream(s, indent + "  ", v.localLoopClosureId);
