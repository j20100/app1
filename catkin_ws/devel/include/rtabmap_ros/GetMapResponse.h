...
struct MD5Sum< ::rtabmap_ros::GetMapResponse_<ContainerAllocator> >
{
  ...
  {
    return "40717072f56f9384c7a0d4ab4bbff823";
  }

  static const char* value(const ::rtabmap_ros::GetMapResponse_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x40717072f56f9384ULL;
  static const uint64_t static_value2 = 0xc7a0d4ab4bbff823ULL;
};
