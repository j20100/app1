...
struct MD5Sum< ::rtabmap_ros::MapData_<ContainerAllocator> >
{
  ...
  {
    return "6b367704e520148d04af9f6848659a47";
  }

  static const char* value(const ::rtabmap_ros::MapData_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x6b367704e520148dULL;
  static const uint64_t static_value2 = 0x04af9f6848659a47ULL;
};
