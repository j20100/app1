...
struct MD5Sum< ::rtabmap_ros::NodeData_<ContainerAllocator> >
{
  ...
  {
    return "0bf4967fbd64111679b9df6a8b013fa5";
  }

  static const char* value(const ::rtabmap_ros::NodeData_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x0bf4967fbd641116ULL;
  static const uint64_t static_value2 = 0x79b9df6a8b013fa5ULL;
};
