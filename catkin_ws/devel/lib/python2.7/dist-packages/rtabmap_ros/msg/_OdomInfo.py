...
class OdomInfo(genpy.Message):
  _md5sum = "bb11dda76811d80a5965a15c6b7baf24"
...
"""
  __slots__ = ['header','lost','matches','inliers','variance','features','localMapSize','timeEstimation','timeParticleFiltering','stamp','interval','distanceTravelled','type','wordsKeys','wordsValues','wordMatches','wordInliers','refCorners','newCorners','cornerInliers','transform','transformFiltered']
  _slot_types = ['std_msgs/Header','bool','int32','int32','float32','int32','int32','float32','float32','float32','float32','float32','int32','int32[]','rtabmap_ros/KeyPoint[]','int32[]','int32[]','rtabmap_ros/Point2f[]','rtabmap_ros/Point2f[]','int32[]','geometry_msgs/Transform','geometry_msgs/Transform']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,lost,matches,inliers,variance,features,localMapSize,timeEstimation,timeParticleFiltering,stamp,interval,distanceTravelled,type,wordsKeys,wordsValues,wordMatches,wordInliers,refCorners,newCorners,cornerInliers,transform,transformFiltered
