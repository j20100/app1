...
class NodeData(genpy.Message):
  _md5sum = "0bf4967fbd64111679b9df6a8b013fa5"
...
"""
  __slots__ = ['id','mapId','weight','stamp','label','pose','image','depth','fx','fy','cx','cy','baseline','localTransform','laserScan','laserScanMaxPts','laserScanMaxRange','userData','wordIds','wordKpts','wordPts']
  _slot_types = ['int32','int32','int32','float64','string','geometry_msgs/Pose','uint8[]','uint8[]','float32[]','float32[]','float32[]','float32[]','float32','geometry_msgs/Transform[]','uint8[]','int32','float32','uint8[]','int32[]','rtabmap_ros/KeyPoint[]','sensor_msgs/PointCloud2']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       id,mapId,weight,stamp,label,pose,image,depth,fx,fy,cx,cy,baseline,localTransform,laserScan,laserScanMaxPts,laserScanMaxRange,userData,wordIds,wordKpts,wordPts
